...
href="http://github.com/infochimps-labs/wukong">Wukong</a>, write some
<a href="http://github.com/infochimps-labs/wukong#processors>simple
processors</a>, and read about the structure of a <a
href="http://en.wikipedia.org/wiki/MapReduce">map/reduce job</a>.
